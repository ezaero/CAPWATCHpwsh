...
3. **Filter Users for Group Membership**: Filters users based on their CAPID, resolved from the beta Microsoft Graph `employeeId` property, and ensures they have a valid email address.
